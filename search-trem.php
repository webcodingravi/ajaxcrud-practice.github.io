...
$offset = ($page - 1) * $limit;
$sql = "SELECT * FROM student WHERE stu_name LIKE '%{$search_trem}%' OR last_name LIKE '%{$search_trem}%' OR 
Age LIKE '%{$search_trem}%' OR City LIKE '%{$search_trem}%'";
